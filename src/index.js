...
frmvalidator.addValidation("name", "req", "Hey I've got to know your name!");
frmvalidator.addValidation("email", "req", "Don't forget your email address!");
frmvalidator.addValidation("email", "email", "Please enter a valid email address");



//nav bar scrollup functionality
(function($) {
  'use strict';
